...
class CompoundListViewModel extends ChangeNotifier {
  ...
  Future getMemberCompounding(String memberID) async {
    try {
      setViewState(ViewState.Busy);
      Response response = await _dioService.get().get(
          '''$baseUrl/$GET_equity_sharing_form?fields=["creation","name","sharing_type","member","capital_amount","compounding_tenure","schedule_release_date","approval_status"]&filters=[["sharing_type","=","Compound Interest"]]''');
